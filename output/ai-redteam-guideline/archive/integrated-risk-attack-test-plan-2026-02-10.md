...
5. ✅ **Test Design Specification Approved**: Risk-attack-test mapping complete (Section 3 of this document)
...
8. ✅ **Stakeholder Availability Confirmed**: System Owner, Domain Experts available for consultation during testing
9. ✅ **Evidence Collection Setup**: Logging, screenshot capture, API recording mechanisms operational
10. ✅ **No Active Incidents**: Target system is stable (no ongoing outages or incidents that would interfere with testing)
...
8. ✅ **Attack Pattern Coverage**: Documented coverage % of attack patterns for each risk category
...
13. ✅ **Residual Risk Calculated**: Residual risk after testing has been quantified and compared to risk appetite
...
| Deliverable | Description | Owner | Delivery Timing | Audience |
|---|---|---|---|---|
| **Test Plan** (This Document) | Customized test plan with risk-attack-test mapping | RTL | Before testing begins (Design stage output) | PS, SO, RTL, EA |
| **Test Execution Log** | Detailed log of all test cases executed with inputs, outputs, results | RTO | Daily during execution | RTL (reviewed), SO (on request) |
| **Risk-Attack-Test Traceability Report** | Mapping showing which risks were verified by which tests and results | RTL | End of execution | PS, SO, Auditors |
| **Finding Report** | Detailed findings with severity, evidence, reproduction steps, impact | RTL | End of analysis stage | PS, SO, Security Team |
| **Red Team Final Report** | Comprehensive report per phase-3-normative-core.md Section 10 | RTL | End of reporting stage | PS, SO, Exec Leadership, Regulators (if applicable) |
| **Residual Risk Assessment** | Quantified residual risk after testing and any mitigations | RTL | End of engagement | PS, SO (for risk acceptance decision) |
| **Evidence Artifacts** | Screenshots, logs, API responses, conversation exports | RTO | Collected during execution, delivered end of engagement | RTL (reviewed), SO (archived) |
...
|---|---|---|---|
| 1.0 | 2026-02-10 | Testing-Agent (AI Red Team Guideline Project) | Initial template release integrating risk-analyst, attack-researcher, and testing-agent outputs |

**Status:** Template for Customization (per-engagement customization required)
**Next Review Date:** Quarterly (aligned with risk-trends-report.md updates)
